...
export const SideBar = () => {
  ...
  return (
    <div
      className={`col-span-1 z-10 row-start-1 row-end-13 absolute lg:relative h-full lg:h-auto border-r-2 border-secondary_light flex flex-col items-center gap-12 py-10 bg-secondary_light_2 transition-all duration-500 ${
        openHamburger
    ...
    >
      <figure>
        <img src={demoImage} alt="company logo" />
      </figure>
